    ...
    <div className="p-4 space-y-4 max-w-md mx-auto">
      ...
      <div className="bg-white rounded-2xl p-3 shadow-sm border border-gray-100 space-y-2">
        ...
        <div className="flex gap-2">
          <input type="date" value={filterDateFrom} onChange={e => setFilterDateFrom(e.target.value)} className="flex-1 px-3 py-2 rounded-xl border border-gray-200 text-sm bg-gray-50" />
          <input type="date" value={filterDateTo} onChange={e => setFilterDateTo(e.target.value)} className="flex-1 px-3 py-2 rounded-xl border border-gray-200 text-sm bg-gray-50" />
        </div>
      </div>
        ...
        <div className="space-y-3">
          {reports.map(report => (
            ...
            >
              ...
              <p className="text-sm text-gray-600 mt-2 line-clamp-2">{report.acceptance_report_items}</p>
            </Link>
          ))}
        </div>
      )}

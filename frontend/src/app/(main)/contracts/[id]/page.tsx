              ...
              {editing ? (
                <>
                  ...
                  <div><label className="block text-sm font-medium text-gray-500 mb-1">簽約日期</label>
                    <DateInput value={toInputDate(form.sign_date)} onChange={val => setForm({...form, sign_date: val || ''})} className="input-field" /></div>
                  <div><label className="block text-sm font-medium text-gray-500 mb-1">開始日期</label>
                    <DateInput value={toInputDate(form.start_date)} onChange={val => setForm({...form, start_date: val || ''})} className="input-field" /></div>
                  <div><label className="block text-sm font-medium text-gray-500 mb-1">結束日期</label>
                    <DateInput value={toInputDate(form.end_date)} onChange={val => setForm({...form, end_date: val || ''})} className="input-field" /></div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <DateInput value={toInputDate(voForm.submitted_date)} onChange={val => setVoForm({ ...voForm, submitted_date: val || '' })} className="input-field" disabled={!!voDetail && !voEditing} />
            </div>

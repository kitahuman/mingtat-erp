        ...
        <form onSubmit={handleCreate} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <DateInput value={form.sign_date} onChange={v => setForm({...form, sign_date: v})} className="input-field" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">開始日期</label>
              <DateInput value={form.start_date} onChange={v => setForm({...form, start_date: v})} className="input-field" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">結束日期</label>
              <DateInput value={form.end_date} onChange={v => setForm({...form, end_date: v})} className="input-field" />
            </div>
          </div>

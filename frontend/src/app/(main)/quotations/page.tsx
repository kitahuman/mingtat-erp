...
function ClientSearchSelect({
  ...
  const filtered = clientPartners.filter(
    (p: any) =>
      !search ||
      p.name?.toLowerCase().includes(search.toLowerCase()) ||
      p.code?.toLowerCase().includes(search.toLowerCase()),
  );
  const selected = clientPartners.find(
...
export default function QuotationsPage() {
  ...
  const setTypeFilter = (newTypeFilter: string) => saveState((prev) => ({ ...prev, typeFilter: newTypeFilter }));
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: true,
      render: (v: any) => (
        <span className="max-w-[150px] truncate block font-mono">
          {v || '-'}
        </span>
      ),
    },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <DateInput
                ...
                onChange={(val) =>
                  setForm({ ...form, quotation_date: val || '' })
                }
                className="input-field"
                required
              />
            ...
            <div>
              ...
              <ClientContractCombobox
                ...
                onChange={(val) =>
                  setForm({ ...form, contract_name: val || '' })
                }
              />
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 border-b">
                    ...
                    <th className="px-2 py-2 text-left min-w-[220px]">
                      項目名稱 / 描述
                    </th>
                ...
                <tbody>
                  {form.items.map((item: any, idx: number) => (
                    <tr key={idx} className="border-b">
                      <td className="px-2 py-1 text-gray-500 align-top pt-2">
                        {idx + 1}
                      </td>
                ...
                <tfoot>
                  <tr className="bg-gray-50 font-bold">
                    ...
                    <td className="px-2 py-2 text-right font-mono text-primary-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, validity_period: e.target.value })
                }
                className="input-field"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                value={form.external_remark}
                onChange={(e) =>
                  setForm({ ...form, external_remark: e.target.value })
                }
                className="input-field"
                rows={2}
                placeholder="顯示在報價單 PDF 上，給客戶看"
              />
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1">

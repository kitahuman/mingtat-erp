      ...
      render: (v: any, row: any) =>
        v > 0 ? (
          <span className="font-mono">
            ${Number(v).toLocaleString()}/{row.day_unit || 'JOB'}
          </span>
        ) : (
          '-'
        ),
    ...
    <div>
      ...
      <div className="card">
        <InlineEditDataTable
          ...
          onRowClick={(row, event) => openWorkspacePath(`/project-rate-cards/${row.id}`, undefined, event)}
          loading={loading}
          sortBy={sortBy}
          sortOrder={sortOrder}
          onSort={(f, o) => {
              ...
              <div>
                ...
                <div className="flex gap-1">
                  <input
                    ...
                    value={form.day_rate}
                    onChange={(e) =>
                      setForm({ ...form, day_rate: e.target.value })
                    }
                  ...
                  <select
                    value={form.day_unit}
                    onChange={(e) =>
                      setForm({ ...form, day_unit: e.target.value })
                    }

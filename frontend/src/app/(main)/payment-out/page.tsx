        ...
        if (row.payroll_id) {
          return (
            <button
              ...
              onClick={(e) => {
                e.stopPropagation();
                openWorkspacePath(`/payroll/${row.payroll_id}`, undefined, e);
              }}
            >
              糧單
            </button>
        ...
        if (linkedExpenseId) {
          return (
            <button
              ...
              onClick={(e) => {
                e.stopPropagation();
                openWorkspacePath(`/expenses/${linkedExpenseId}`, undefined, e);
              }}
            >
              支出
            </button>
  ...
  return (
    <div>
      ...
      <InlineEditDataTable
        ...
        onRowClick={(row: any, event) => openWorkspacePath(`/payment-out/${row.id}`, undefined, event)}

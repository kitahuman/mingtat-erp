      ...
      <div className="bg-white rounded-lg shadow-sm border p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          ...
          <SearchableSelect
            value={filterStatus}
            onChange={(val) => {
              setFilterStatus(val as string | null);
              setPage(1);
            }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <SearchableSelect
            ...
            onChange={(val) => {
              setFilterProjectName(val as string | null);
              setPage(1);
            }}
          ...
          <SearchableSelect
            value={filterClient}
            onChange={(val) => {
              setFilterClient(val as string | null);
              setPage(1);
            }}
          ...
          <SearchableSelect
            ...
            onChange={(val) => {
              setFilterContractNo(val as string | null);
              setPage(1);
            }}
              ...
              <thead className="bg-gray-50 border-b">
                <tr>
                  ...
                  <th
                    ...
                    onClick={() => handleSort('daily_report_date')}
                  >
                    日期
                    <SortIcon field="daily_report_date" />
                  </th>
                  <th
                    className="px-4 py-3 text-left font-medium text-gray-600 cursor-pointer select-none"
                    onClick={() => handleSort('daily_report_project_name')}
                  >
                    工程
                    <SortIcon field="daily_report_project_name" />
                  </th>
                  <th
                    className="px-4 py-3 text-left font-medium text-gray-600 cursor-pointer select-none"
                    onClick={() => handleSort('daily_report_project_location')}
                  >
                    工程地點
                    <SortIcon field="daily_report_project_location" />
                  </th>
                  <th
                    className="px-4 py-3 text-left font-medium text-gray-600 cursor-pointer select-none"
                    onClick={() => handleSort('daily_report_client_name')}
                  >
                    客戶
                    <SortIcon field="daily_report_client_name" />
                  </th>
                  <th
                    className="px-4 py-3 text-left font-medium text-gray-600 cursor-pointer select-none"
                    onClick={() =>
                      handleSort('daily_report_client_contract_no')
                    }
                  >
                    客戶合約
                    <SortIcon field="daily_report_client_contract_no" />
                  </th>
                  <th
                    className="px-4 py-3 text-left font-medium text-gray-600 cursor-pointer select-none"
                    onClick={() => handleSort('daily_report_shift_type')}
                  >
                    更次
                    <SortIcon field="daily_report_shift_type" />
                  </th>
                  ...
                  <th
                    className="px-4 py-3 text-left font-medium text-gray-600 cursor-pointer select-none"
                    onClick={() => handleSort('daily_report_status')}
                  >
                    狀態
                ...
                {reports.map((report) => (
                  <>
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-sm">
                        {report.daily_report_client_name ||
                          report.client?.name ||
                          '-'}
                      </td>

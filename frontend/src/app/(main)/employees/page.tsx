        ...
        <form onSubmit={handleCreate} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div><label className="block text-sm font-medium text-gray-700 mb-1">電話</label><input value={form.phone} onChange={e => setForm({...form, phone: e.target.value})} className="input-field" /></div>
             <div><label className="block text-sm font-medium text-gray-700 mb-1">入職日期</label><DateInput value={form.join_date} onChange={v => setForm({...form, join_date: v})} className="input-field" /></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">入職日期</label>
                 <DateInput value={convertForm.join_date} onChange={v => setConvertForm({...convertForm, join_date: v})} className="input-field" />
              </div>
              <div>

...
export default function RentalRateCardsPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      editable: true,
      editType: 'select' as const,
      editOptions: [{ value: '', label: '不適用' }, ...vehicleTypeOptions],
      render: (v: any) => v || '-',
    },
    {
      key: 'origin',
      ...
      editable: true,
      editType: 'select' as const,
      editOptions: [{ value: '', label: '不適用' }, ...locationOptions],
      render: (v: any) => v || '-',
    },
    {
      key: 'destination',
    ...
    },
    {
      ...
      render: (v: any, row: any) => {
        const r = Number(v || row.day_rate || 0);
        return r > 0 ? (
    ...
    <div>
      ...
      <div className="card">
        <InlineEditDataTable
          ...
          onRowClick={(row, event) => openWorkspacePath(`/rental-rate-cards/${row.id}`, undefined, event)}
          loading={loading}
          sortBy={sortBy}
          sortOrder={sortOrder}
          onSort={(f, o) => {

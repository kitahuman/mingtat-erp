...
export default function VehiclesPage() {
  ...
  const columns = [
    ...
    { key: 'vehicle_mud_tail_expiry', label: '泥尾到期', sortable: true, editable: true, editType: 'date' as const, render: (v: string) => fmtDate(v), filterRender: filterExpiry, exportRender: (v: string) => v || '' },

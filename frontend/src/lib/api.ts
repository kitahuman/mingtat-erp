...
export const employeesApi = {
  ...
  addNickname: (id: number, nickname: string, source?: string) =>
    api.post(`/employees/${id}/nicknames`, { nickname, source }),
  ...
  checkMerge: (sourceId: number, targetId: number) =>
    api.get(`/employees/${sourceId}/check-merge`, {
      params: { target_employee_id: targetId },
    }),
  merge: (
    sourceId: number,
    targetEmployeeId: number,
    forceOverwriteSalary?: boolean,
  ) =>
    api.post(`/employees/${sourceId}/merge`, {
...
export const vehiclesApi = {
  ...
  removePlate: (id: number, data: any) =>
    api.post(`/vehicles/${id}/remove-plate`, data),
  transfer: (id: number, data: any) =>
    api.post(`/vehicles/${id}/transfer`, data),
  addTransferHistory: (id: number, data: any) =>
    api.post(`/vehicles/${id}/transfer-history`, data),
  addHistoryEvent: (id: number, data: any) =>
    api.post(`/vehicles/${id}/history-events`, data),
  scrap: (id: number, data?: any) =>
    api.post(`/vehicles/${id}/scrap`, data || {}),
...
export const vehiclePlatesApi = {
  ...
  assign: (id: number, data: any) =>
    api.post(`/vehicle-plates/${id}/assign`, data),
  transfer: (id: number, data: any) =>
    api.post(`/vehicle-plates/${id}/transfer`, data),
  addAssignmentHistory: (id: number, data: any) =>
    api.post(`/vehicle-plates/${id}/history/assignment`, data),
  addTransferHistory: (id: number, data: any) =>
    api.post(`/vehicle-plates/${id}/history/transfer`, data),
...
export const quotationsApi = {
  ...
  accept: (id: number, options?: any) =>
    api.post(`/quotations/${id}/accept`, options || {}),
  byProject: (projectId: number) =>
    api.get(`/quotations/by-project/${projectId}`),
  syncToRateCards: (id: number, options?: any) =>
    api.post(`/quotations/${id}/sync-to-rate-cards`, options || {}),
...
export const fleetRateCardsApi = {
  ...
  linked: (rateCardId: number) =>
    api.get(`/fleet-rate-cards/linked/${rateCardId}`),
};
...
export const expensesApi = {
  ...
  // Items
  createItem: (id: number, data: any) =>
    api.post(`/expenses/${id}/items`, data),
  updateItem: (id: number, itemId: number, data: any) =>
    api.put(`/expenses/${id}/items/${itemId}`, data),
  deleteItem: (id: number, itemId: number) =>
    api.delete(`/expenses/${id}/items/${itemId}`),
  // Attachments
...
export const attendancesApi = {
  ...
  // 打卡配對增強
  matchDetail: (workLogId: number) =>
    api.get(`/attendances/match-detail/${workLogId}`),
  ...
  getPendingConversionCount: (params?: {
    date_from?: string;
    date_to?: string;
    employee_id?: number;
...
export const bqSectionsApi = {
  ...
  create: (contractId: number, data: any) =>
    api.post(`/contracts/${contractId}/bq-sections`, data),
  update: (contractId: number, id: number, data: any) =>
    api.put(`/contracts/${contractId}/bq-sections/${id}`, data),
  delete: (contractId: number, id: number) =>
    api.delete(`/contracts/${contractId}/bq-sections/${id}`),
};

// BQ Items (BQ 項目)
export const bqItemsApi = {
  list: (contractId: number, params?: any) =>
    api.get(`/contracts/${contractId}/bq-items`, { params }),
  create: (contractId: number, data: any) =>
    api.post(`/contracts/${contractId}/bq-items`, data),
  update: (contractId: number, id: number, data: any) =>
    api.put(`/contracts/${contractId}/bq-items/${id}`, data),
  delete: (contractId: number, id: number) =>
    api.delete(`/contracts/${contractId}/bq-items/${id}`),
  batchCreate: (contractId: number, items: any[]) =>
...
export const variationOrdersApi = {
  list: (contractId: number) =>
    api.get(`/contracts/${contractId}/variation-orders`),
  get: (contractId: number, id: number) =>
    api.get(`/contracts/${contractId}/variation-orders/${id}`),
  create: (contractId: number, data: any) =>
    api.post(`/contracts/${contractId}/variation-orders`, data),
  update: (contractId: number, id: number, data: any) =>
    api.put(`/contracts/${contractId}/variation-orders/${id}`, data),
  delete: (contractId: number, id: number) =>
    api.delete(`/contracts/${contractId}/variation-orders/${id}`),
};
...
export const paymentApplicationsApi = {
  list: (contractId: number) =>
    api.get(`/contracts/${contractId}/payment-applications`),
  get: (contractId: number, paId: number) =>
    api.get(`/contracts/${contractId}/payment-applications/${paId}`),
  create: (contractId: number, data: any) =>
    api.post(`/contracts/${contractId}/payment-applications`, data),
  update: (contractId: number, paId: number, data: any) =>
    api.put(`/contracts/${contractId}/payment-applications/${paId}`, data),
  delete: (contractId: number, paId: number) =>
    api.delete(`/contracts/${contractId}/payment-applications/${paId}`),
  ...
  addMaterial: (contractId: number, paId: number, data: any) =>
    api.post(
      `/contracts/${contractId}/payment-applications/${paId}/materials`,
      data,
    ),
  updateMaterial: (
    contractId: number,
    ...
    api.put(
      `/contracts/${contractId}/payment-applications/${paId}/materials/${materialId}`,
      data,
    ),
  ...
  addDeduction: (contractId: number, paId: number, data: any) =>
    api.post(
      `/contracts/${contractId}/payment-applications/${paId}/deductions`,
      data,
    ),
  updateDeduction: (
    contractId: number,
    ...
    api.put(
      `/contracts/${contractId}/payment-applications/${paId}/deductions/${deductionId}`,
      data,
    ),
  ...
  certify: (contractId: number, paId: number, data: any) =>
    api.post(
      `/contracts/${contractId}/payment-applications/${paId}/certify`,
      data,
    ),
  recordPayment: (contractId: number, paId: number, data: any) =>
    api.post(
      `/contracts/${contractId}/payment-applications/${paId}/record-payment`,
      data,
    ),
...
export const paymentInApi = {
  ...
  byInvoice: (invoiceId: number) => api.get(`/payment-in/by-invoice/${invoiceId}`),
  filterOptions: (column: string) => api.get(`/payment-in/filter-options`, { params: { column } }),
...
export const invoicesApi = {
  ...
  deletePayment: (id: number, paymentId: number) =>
    api.delete(`/invoices/${id}/payment/${paymentId}`),
  getPayments: (id: number) => api.get(`/invoices/${id}/payments`),
  linkWorkLogs: (id: number, workLogIds: number[]) =>
    api.post(`/invoices/${id}/work-logs`, { work_log_ids: workLogIds }),
  unlinkWorkLogs: (id: number, workLogIds: number[]) =>
    api.delete(`/invoices/${id}/work-logs`, {
      data: { work_log_ids: workLogIds },
    }),
  ...
  savePrepare: (
    id: number,
    data: {
      drafts: { work_log_id: number; draft_data: Record<string, unknown> }[];
    },
  ) => api.put(`/invoices/${id}/prepare`, data),
...
export const retentionApi = {
  ...
  sync: (contractId: number) =>
    api.post(`/contracts/${contractId}/retention/sync`),
  createRelease: (contractId: number, data: any) =>
    api.post(`/contracts/${contractId}/retention/release`, data),
  deleteRelease: (contractId: number, releaseId: number) =>
    api.delete(`/contracts/${contractId}/retention/release/${releaseId}`),
};
...
export const bankReconciliationApi = {
  ...
  deleteTransaction: (id: number) =>
    api.delete(`/bank-reconciliation/transactions/${id}`),
  updateRemark: (id: number, remark: string) =>
    api.put(`/bank-reconciliation/transactions/${id}/remark`, {
...
export const equipmentProfitApi = {
  ...
  updateCommission: (
    ...
    api.put(`/equipment-profit/settings/${equipmentType}/${equipmentId}`, {
...
export const verificationApi = {
  ...
  performMatchAction: (
    matchId: number,
    data: { action: string; override_data?: any; notes?: string },
  ...
  getRecordFilterOptions: (
    ...
    params?: VerificationRecordsParams,
  ) =>
    api.get<{ options: VerificationRecordFilterOption[] }>(
      `/verification/records/filter-options/${column}`,
      { params },
    ),
  ...
  // 刪除 OCR 結果
  ocrDelete: (ocrId: number) => api.delete(`/verification/ocr/${ocrId}`),

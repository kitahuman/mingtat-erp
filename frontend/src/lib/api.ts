...
export const employeesApi = {
  ...
  merge: (sourceId: number, targetEmployeeId: number, forceOverwriteSalary?: boolean) => api.post(`/employees/${sourceId}/merge`, { target_employee_id: targetEmployeeId, force_overwrite_salary: forceOverwriteSalary }),
  // Emp code utilities

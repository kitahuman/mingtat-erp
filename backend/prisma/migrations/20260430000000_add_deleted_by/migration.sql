...
ALTER TABLE "companies" ADD COLUMN IF NOT EXISTS "deleted_by" INTEGER;
...
ALTER TABLE "vehicles" ADD COLUMN IF NOT EXISTS "deleted_by" INTEGER;
...
ALTER TABLE "machinery" ADD COLUMN IF NOT EXISTS "deleted_by" INTEGER;
...
ALTER TABLE "partners" ADD COLUMN IF NOT EXISTS "deleted_by" INTEGER;
...
ALTER TABLE "contracts" ADD COLUMN IF NOT EXISTS "deleted_by" INTEGER;
...
ALTER TABLE "quotations" ADD COLUMN IF NOT EXISTS "deleted_by" INTEGER;
...
ALTER TABLE "rate_cards" ADD COLUMN IF NOT EXISTS "deleted_by" INTEGER;
...
ALTER TABLE "expenses" ADD COLUMN IF NOT EXISTS "deleted_by" INTEGER;
...
ALTER TABLE "work_logs" ADD COLUMN IF NOT EXISTS "deleted_by" INTEGER;
...
ALTER TABLE "daily_reports" ADD COLUMN IF NOT EXISTS "daily_report_deleted_by" INTEGER;

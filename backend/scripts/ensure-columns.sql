...
-- company_id columns (unify company reference to Company table)
...
-- Data migration: populate company_id from company_profile_id via company_profiles
UPDATE "work_logs" wl
...
-- Foreign key constraints for company_id
DO $$ BEGIN
...
-- ============================================================
-- Verification Module Tables (from 20260407200000_add_verification_module)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS "verification_record_chits" (
    "id" SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS "verification_gps_summaries" (
    "id" SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS "verification_wa_messages" (
    "id" SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS "verification_wa_orders" (
    "id" SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS "verification_wa_order_items" (
    "id" SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS "verification_nickname_mappings" (
    "id" SERIAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS "verification_action_logs" (
    "id" SERIAL NOT NULL,
...
-- ============================================================
-- Verification Module Indexes
-- ============================================================

CREATE UNIQUE INDEX IF NOT EXISTS "verification_sources_source_code_key" ON "verification_sources"("source_code");

CREATE UNIQUE INDEX IF NOT EXISTS "verification_batches_batch_code_key" ON "verification_batches"("batch_code");
CREATE INDEX IF NOT EXISTS "verification_batches_batch_source_id_idx" ON "verification_batches"("batch_source_id");
CREATE INDEX IF NOT EXISTS "verification_batches_batch_upload_time_idx" ON "verification_batches"("batch_upload_time");
CREATE INDEX IF NOT EXISTS "verification_batches_batch_period_year_batch_period_month_idx" ON "verification_batches"("batch_period_year", "batch_period_month");

CREATE INDEX IF NOT EXISTS "verification_records_record_batch_id_idx" ON "verification_records"("record_batch_id");
CREATE INDEX IF NOT EXISTS "verification_records_record_vehicle_no_idx" ON "verification_records"("record_vehicle_no");
CREATE INDEX IF NOT EXISTS "verification_records_record_work_date_idx" ON "verification_records"("record_work_date");
CREATE INDEX IF NOT EXISTS "verification_records_record_slip_no_idx" ON "verification_records"("record_slip_no");
CREATE INDEX IF NOT EXISTS "verification_records_record_driver_name_idx" ON "verification_records"("record_driver_name");

CREATE UNIQUE INDEX IF NOT EXISTS "verification_record_chits_chit_record_id_chit_no_key" ON "verification_record_chits"("chit_record_id", "chit_no");
CREATE INDEX IF NOT EXISTS "verification_record_chits_chit_record_id_idx" ON "verification_record_chits"("chit_record_id");
CREATE INDEX IF NOT EXISTS "verification_record_chits_chit_no_idx" ON "verification_record_chits"("chit_no");

CREATE INDEX IF NOT EXISTS "verification_matches_match_work_record_id_idx" ON "verification_matches"("match_work_record_id");
CREATE INDEX IF NOT EXISTS "verification_matches_match_status_idx" ON "verification_matches"("match_status");
CREATE INDEX IF NOT EXISTS "verification_matches_match_source_id_idx" ON "verification_matches"("match_source_id");
CREATE INDEX IF NOT EXISTS "verification_matches_match_created_at_idx" ON "verification_matches"("match_created_at");

CREATE INDEX IF NOT EXISTS "verification_gps_summaries_gps_summary_vehicle_no_gps_summ_idx" ON "verification_gps_summaries"("gps_summary_vehicle_no", "gps_summary_date");

CREATE INDEX IF NOT EXISTS "verification_ocr_results_ocr_batch_id_idx" ON "verification_ocr_results"("ocr_batch_id");
CREATE INDEX IF NOT EXISTS "verification_ocr_results_ocr_status_idx" ON "verification_ocr_results"("ocr_status");

CREATE INDEX IF NOT EXISTS "verification_wa_messages_wa_msg_group_id_idx" ON "verification_wa_messages"("wa_msg_group_id");
CREATE INDEX IF NOT EXISTS "verification_wa_messages_wa_msg_timestamp_idx" ON "verification_wa_messages"("wa_msg_timestamp");
CREATE INDEX IF NOT EXISTS "verification_wa_messages_wa_msg_ai_classified_idx" ON "verification_wa_messages"("wa_msg_ai_classified");
CREATE INDEX IF NOT EXISTS "verification_wa_messages_wa_msg_remote_id_idx" ON "verification_wa_messages"("wa_msg_remote_id");

CREATE INDEX IF NOT EXISTS "verification_wa_orders_wa_order_date_idx" ON "verification_wa_orders"("wa_order_date");
CREATE INDEX IF NOT EXISTS "verification_wa_orders_wa_order_status_idx" ON "verification_wa_orders"("wa_order_status");
CREATE INDEX IF NOT EXISTS "verification_wa_orders_wa_order_msg_id_idx" ON "verification_wa_orders"("wa_order_msg_id");

CREATE INDEX IF NOT EXISTS "verification_wa_order_items_wa_item_order_id_idx" ON "verification_wa_order_items"("wa_item_order_id");
CREATE INDEX IF NOT EXISTS "verification_wa_order_items_wa_item_driver_nickname_idx" ON "verification_wa_order_items"("wa_item_driver_nickname");
CREATE INDEX IF NOT EXISTS "verification_wa_order_items_wa_item_vehicle_no_idx" ON "verification_wa_order_items"("wa_item_vehicle_no");
CREATE INDEX IF NOT EXISTS "verification_wa_order_items_wa_item_contract_no_idx" ON "verification_wa_order_items"("wa_item_contract_no");

CREATE INDEX IF NOT EXISTS "verification_nickname_mappings_nickname_value_idx" ON "verification_nickname_mappings"("nickname_value");
CREATE INDEX IF NOT EXISTS "verification_nickname_mappings_nickname_employee_id_idx" ON "verification_nickname_mappings"("nickname_employee_id");

CREATE INDEX IF NOT EXISTS "verification_action_logs_log_user_id_idx" ON "verification_action_logs"("log_user_id");
CREATE INDEX IF NOT EXISTS "verification_action_logs_log_match_id_idx" ON "verification_action_logs"("log_match_id");
CREATE INDEX IF NOT EXISTS "verification_action_logs_log_created_at_idx" ON "verification_action_logs"("log_created_at");

-- ============================================================
-- Verification Module Foreign Keys
-- ============================================================
...
-- ============================================================
-- Verification Module Seed Data (default verification_sources)
-- ============================================================
...
-- ============================================================
-- Verification Phase 1 Supplement (from 20260409000000)
-- ============================================================

ALTER TABLE "verification_matches" ADD COLUMN IF NOT EXISTS "match_method" VARCHAR(30);
ALTER TABLE "verification_records" ADD COLUMN IF NOT EXISTS "record_employee_id" INTEGER;
ALTER TABLE "verification_records" ADD COLUMN IF NOT EXISTS "record_employee_name" VARCHAR(100);

CREATE INDEX IF NOT EXISTS "verification_records_record_employee_id_idx" ON "verification_records"("record_employee_id");
CREATE INDEX IF NOT EXISTS "verification_matches_match_method_idx" ON "verification_matches"("match_method");

-- Update clock source type from 'excel' to 'system'
UPDATE "verification_sources" SET "source_type" = 'system' WHERE "source_code" = 'clock';

-- ============================================================
-- Partners: short_name add then drop (from 20260407000000 / 20260407100000)
-- ============================================================
...
DO $$ BEGIN
  ALTER TABLE "subcontractor_fleet_drivers" RENAME COLUMN "vehicle_type" TO "machine_type";
EXCEPTION WHEN undefined_column THEN NULL;
END $$;
-- ============================================================
-- WhatsApp Order Modification Tracking (from 20260412000000)
-- ============================================================

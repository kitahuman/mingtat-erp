...
async function seed() {
  ...
  // Seed MCL vehicles
  const mclVehicles = [
    { plate_number: 'MC2600', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'MV897', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'TF3306', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'VE987', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'WY8724', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'XW1778', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'YB6268', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'ZY4778', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'XH8301', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'YA987', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'PJ165', machine_type: '夾車' },
    { plate_number: 'WG1750', machine_type: '勾斗車' },
    { plate_number: 'NZ1886', machine_type: '吊車' },
    { plate_number: '54450T', machine_type: '拖架' },
    { plate_number: 'LT3318', machine_type: '拖頭' },
    { plate_number: 'XB6673', machine_type: '輕型貨車' },
  ];

  const dtlVehicles = [
    { plate_number: 'EM987', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'JR981', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'PR971', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'WC987', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'WD190', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'YE6679', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'YT6383', machine_type: '泥頭車', tonnage: 30 },
    { plate_number: 'UH1883', machine_type: '夾車' },
    { plate_number: 'KP440', machine_type: '領航車' },
    { plate_number: 'YU940', machine_type: '領航車' },
    { plate_number: 'TN8808', machine_type: '領航車' },
  ];

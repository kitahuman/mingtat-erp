...
import { CreateSalaryConfigDto, UpdateSalaryConfigDto } from './dto/create-salary-config.dto';
...
export class SalaryConfigController {
  ...
  @Post()
  create(@Body() dto: CreateSalaryConfigDto, @Request() req: any) {
  ...
  @Put(':id')
  update(@Param('id') id: number, @Body() dto: UpdateSalaryConfigDto, @Request() req: any) {
